...
def parse_args():
    ...
    parser.add_argument(dataset='/kaggle/input/train-val-imgs/data', required=True,
    ...
    parser.add_argument(weight='/kaggle/working/Mask_R-CNN/mobile_mask_rcnn_coco.h5', required=False,
